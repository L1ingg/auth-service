...
public class JwtService {
     ...
     * @return токен
     */
    public String generateToken(UserDetails userDetails, Duration duration, TokenType type) {
        Map<String, Object> claims = new HashMap<>();
        if (userDetails instanceof MyCustomUserDetails customUserDetails) {
            claims.put("role", customUserDetails.getRole());
            claims.put("type", type.name());
        }
        return generateToken(claims, userDetails, duration);
    }
     ...
     * @return токен
     */
    private String generateToken(Map<String, Object> extraClaims, UserDetails userDetails, Duration duration) {
